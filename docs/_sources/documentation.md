...
<div style="display:flex;gap:0.75rem;margin:1rem 0;">
  ...
  <a href="https://anonymous.4open.science/r/ManiDreams-DD4E" style="flex:1;text-align:center;padding:0.5rem 1rem;border:1px solid #333;border-radius:0.25rem;text-decoration:none;color:#333;font-weight:500;">GitHub</a>
</div>
```
