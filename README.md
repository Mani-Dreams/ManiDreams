...
```bash
git clone https://anonymous.4open.science/r/ManiDreams-DD4E
cd ManiDreams-DD4E
pip install -e .
```
...
Full documentation is available at the [docs site](https://anonymous.4open.science/w/ManiDreams-DD4E/), including:

- [Why ManiDreams?](https://anonymous.4open.science/w/ManiDreams-DD4E/why_manidreams.html) — Architecture and design principles
- [Core Concepts](https://anonymous.4open.science/w/ManiDreams-DD4E/dris.html) — DRIS, Cage, TSIP, Solvers
- [Supported Tasks](https://anonymous.4open.science/w/ManiDreams-DD4E/supported_tasks.html) — Object pushing, catching, picking, and more
- [API Reference](https://anonymous.4open.science/w/ManiDreams-DD4E/api/index.html)
